...
compare_object([NAME1, ILLNESSES1, CONTRAS1, PROBABILITY1], [_, _, _, PROBABILITY2], [NAME1, ILLNESSES1, CONTRAS1, PROBABILITY1]) :- PROBABILITY1 > PROBABILITY2, !.
compare_object([NAME1, ILLNESSES1, CONTRAS1, PROBABILITY1], [NAME2, _, _, PROBABILITY2], [NAME1, ILLNESSES1, CONTRAS1, PROBABILITY1]) :- PROBABILITY1 = PROBABILITY2, NAME1 @=< NAME2, !.
